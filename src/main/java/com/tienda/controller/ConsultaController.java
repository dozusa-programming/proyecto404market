...
public class ConsultaController {
    ...
    public String consultaPractica2(@RequestParam("precioSup") double precio,
            Model model) {
        var lista = productoService.consultaPractica2(precio);
        model.addAttribute("productos", lista);
        model.addAttribute("totalProductos", lista.size());
        model.addAttribute("precioSup", precio);
        return "consultas/listado";
    }
}
